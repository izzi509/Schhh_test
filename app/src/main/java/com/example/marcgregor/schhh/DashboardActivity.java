...
import com.example.marcgregor.schhh.adapters.CustomAdapter;
...
public class DashboardActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Intent.ACTION_SEARCH.equals(searchIntent.getAction()) ){
            ...
            Toast.makeText(DashboardActivity.this,query, Toast.LENGTH_SHORT).show();
        }

        lvItems = (ListView) findViewById(R.id.lvHotel);
        hotels = new ArrayList<>();
        hotelAdapter = new CustomAdapter(this, hotels);
